...
function DebugSettings(_ref) {
  var useApp = _ref.useApp;

  var _useApp = useApp(),
      logging = _useApp.logging,
      setLogging = _useApp.setLogging; //const [dirty,setDirty] = useState("");


  var _useState = (0, _react.useState)(""),
      _useState2 = _slicedToArray(_useState, 2),
      qid = _useState2[0],
      setQid = _useState2[1]; //const [tsx,setTsx] = useState("");
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_material.Card, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_iconsMaterial.Adb, {}), /*#__PURE__*/(0, _jsxRuntime.jsx)("h3", {
        children: "Debug"
      })]
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.t0 = console;
                      _context.next = 3;
                      return window.AppiClient.NetTsx(qid);

                    case 3:
                      _context.t1 = _context.sent;
                      _context.next = 6;
                      return window.AppiClient.Delta(qid);
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      _context2.next = 3;
                      return window.AppiClient.Get(qid);
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      _context3.next = 3;
                      return window.AppiClient.Dirty();
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      _context4.next = 3;
                      return window.AppiClient.Push(qid);
